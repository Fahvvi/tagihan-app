...
@section('content')
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 mb-6">
        <form action="{{ route('admin.laporan.index') }}" method="GET" class="flex flex-col md:flex-row md:items-end gap-4">
            
            <div class="w-full md:w-1/4">
                <label class="block text-sm font-semibold text-slate-700 mb-2">Bulan</label>
                <div class="relative">
                    <select name="bulan" class="w-full appearance-none px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:outline-blue-500 cursor-pointer">
            ...
            <div class="w-full md:w-1/4">
                ...
                <div class="relative">
                    <select name="tahun" class="w-full appearance-none px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:outline-blue-500 cursor-pointer">
            ...
            <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto mt-2 md:mt-0">
                <button type="submit" class="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-bold transition shadow-lg shadow-blue-200 flex justify-center items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z"></path></svg>
                    Filter
                </button>
                
                <a href="{{ route('admin.laporan.cetak', ['bulan' => $bulan, 'tahun' => $tahun]) }}" target="_blank" class="w-full md:w-auto bg-slate-800 hover:bg-slate-900 text-white px-6 py-3 rounded-xl font-bold transition flex justify-center items-center gap-2">
